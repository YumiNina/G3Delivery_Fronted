<template>
    <section>
        ...
        <div class="columns is-multiline">
            <div class="column" 
            v-for="mesa in repartidor" 
            :key="mesa.mesa.idMesa">
                
                <div class="box">
                    <p class="title is-2 has-text-grey">Repartidor #{{ mesa.mesa.idMesa }}
    ...
    methods:{
                    ...
                    .then(resultado => {
                        if(resultado){
                            this.$buefy.toast.open({
                                message: "Orden del delivery " + id + " cancelada",
                                type: "is-success"
                            })
                            this.crearMesas()
                            this.cargando = false
        ...
        cobrar(mesa){
            this.$buefy.dialog.prompt({
                title: `Cobro de Repartidor #` + mesa.mesa.idMesa,
